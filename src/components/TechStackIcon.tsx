...
function LuaIcon(p: SVGProps<SVGSVGElement>) {
  return <svg viewBox="0 0 24 24" fill="none" {...p}>
    ...
    <circle cx="9.1" cy="9.1" r="2.25" fill="currentColor"/>
    <circle cx="15.4" cy="15.4" r="1.65" fill="currentColor"/>
    <path d="M14.6 6.8a5.8 5.8 0 0 1 2.7 2.2" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round"/>
  </svg>
}
...
function CppIcon(p: SVGProps<SVGSVGElement>) {
  return <svg viewBox="0 0 24 24" fill="none" {...p}>
    <path d="M11.5 7.1a5.2 5.2 0 1 0 0 9.8" stroke="currentColor" strokeWidth="2.7" strokeLinecap="round"/>
    <path d="M15.5 9.2v4.2M13.4 11.3h4.2M19.2 9.2v4.2M17.1 11.3h4.2" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round"/>
  </svg>
}

function CSharpIcon(p: SVGProps<SVGSVGElement>) {
  return <svg viewBox="0 0 24 24" fill="none" {...p}>
    <path d="M16.7 7.4a5.1 5.1 0 1 0 0 9.2" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round"/>
    <path d="M17.2 9.5v5M14.7 12h5M19.2 9.5v5M16.7 12h5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
  </svg>
}

function PhpIcon(p: SVGProps<SVGSVGElement>) {
  return <svg viewBox="0 0 24 24" fill="none" {...p}>
    <ellipse cx="12" cy="12" rx="10" ry="6.1" stroke="currentColor" strokeWidth="1.5"/>
    <text x="12" y="14.2" textAnchor="middle" fontSize="6.3" fontWeight="800" fontFamily="Arial,sans-serif" fill="currentColor">PHP</text>
  </svg>
}

function PythonIcon(p: SVGProps<SVGSVGElement>) {
  return <svg viewBox="0 0 24 24" fill="currentColor" {...p}>
    <path d="M14.25.18l.9.2.73.26.59.3.45.32.34.34.25.34.16.33.1.3.04.26.02.2-.01.13V8.5l-.05.63-.13.55-.21.46-.26.38-.3.31-.33.25-.35.19-.35.14-.33.1-.3.07-.26.04-.21.02H8.77l-.69.05-.59.14-.5.22-.41.27-.33.32-.27.35-.2.36-.15.37-.1.35-.07.32-.04.27-.02.21v3.06H3.17l-.21-.03-.28-.07-.32-.12-.35-.18-.36-.26-.36-.36-.35-.46-.32-.59-.28-.73-.21-.88-.14-1.05-.05-1.23.06-1.22.16-1.04.24-.87.32-.71.36-.57.4-.44.42-.33.42-.24.4-.16.36-.1.32-.05.24-.01h.16l.06.01h8.16v-.83H6.18l-.01-2.75-.02-.37.05-.34.11-.31.17-.28.25-.26.31-.23.38-.2.44-.18.51-.15.58-.12.64-.1.71-.06.77-.04.84-.02 1.27.05zm-6.3 1.98l-.23.33-.08.41.08.41.23.34.33.22.41.09.41-.09.33-.22.23-.34.08-.41-.08-.41-.23-.33-.33-.22-.41-.09-.41.09zm13.09 3.95l.28.06.32.12.35.18.36.27.36.35.35.47.32.59.28.73.21.88.14 1.04.05 1.23-.06 1.23-.16 1.04-.24.86-.32.71-.36.57-.4.45-.42.33-.42.24-.4.16-.36.09-.32.05-.24.02-.16-.01h-8.22v.82h5.84l.01 2.76.02.36-.05.34-.11.31-.17.29-.25.26-.31.23-.38.2-.44.18-.51.15-.58.12-.64.1-.71.06-.77.04-.84.02-1.27-.05-1.06-.13-.91-.21-.77-.29-.66-.36-.54-.42-.43-.47-.33-.51-.24-.54-.16-.57-.1-.59-.04-.61.01-.62.08-.63.17-.6.24-.59.31-.56.36-.51.41-.46.45-.4.49-.34.51-.28.52-.21.52-.15.51-.1.49-.05.47-.01h.62l.01-3.48.02-.64.04-.56.06-.49.1-.42.14-.36.18-.3.22-.23.26-.16.3-.1.33-.06.37-.01.41.02zm-7.85 3.46l-.23.33-.08.41.08.41.23.33.33.22.41.1.41-.1.33-.22.23-.33.08-.41-.08-.41-.23-.33-.33-.22-.41-.1-.41.1z"/>
  </svg>
}
