    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <TextType
              text={["TypeScript", "React + Next.js", "Building for the web"]}
              typingSpeed={75}
              pauseDuration={1500}
              showCursor
              cursorCharacter="_"
        ...
        >
          ...
          >
            I build responsive web experiences with clean interfaces, thoughtful
            interactions, and maintainable code. My focus is making products
