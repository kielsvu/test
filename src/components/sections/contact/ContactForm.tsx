...
const socialLinks = [
  { title: 'GitHub', user: 'Add your username', icon: Github, link: '#' },
  { title: 'LinkedIn', user: 'Add your profile', icon: Linkedin, link: '#' },
  { title: 'Portfolio', user: 'Add your website', icon: Globe2, link: '#' },
  { title: 'Email', user: 'Add your email', icon: MailCheck, link: '#' },
]
        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white/35">Add your profile</p>
            </div>
          </div>
