...
// React — clean stroke-based orbital rings, renders perfectly everywhere
...
// Tailwind — official Simple Icons path
...
// Node.js — official Simple Icons path
...
// Git — official Simple Icons path
...
// GitHub — official Simple Icons path
...
// Lua — real logo: large circle outline + two smaller filled circles (top-right satellite)
function LuaIcon(p: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...p}>
      <circle cx="10.5" cy="13.5" r="8" fill="none" stroke="currentColor" strokeWidth="1.6"/>
      <circle cx="18.5" cy="5.5" r="2.8"/>
      <circle cx="10.5" cy="13.5" r="2.2" fill="none" stroke="currentColor" strokeWidth="1.6"/>
    </svg>
  )
}

// C — proper letter C, not a logo badge
...
// C++ — official Simple Icons path (hexagon badge with C and two plus signs)
...
// C# — correct official Simple Icons path (different from C++)
function CSharpIcon(p: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...p}>
      <path d="M22.394 6c-.167-.29-.398-.543-.652-.69L12.926.22c-.509-.294-1.34-.294-1.848 0L2.26 5.31c-.508.293-.923 1.013-.923 1.6v10.18c0 .294.104.62.271.91.167.29.398.543.652.69l8.816 5.09c.508.293 1.34.293 1.848 0l8.816-5.09c.254-.147.485-.4.652-.69.167-.29.27-.616.27-.91V6.91c.003-.294-.1-.62-.268-.91zM12 19.109c-3.92 0-7.109-3.189-7.109-7.109S8.08 4.891 12 4.891a7.133 7.133 0 0 1 6.156 3.552l-3.076 1.781A3.567 3.567 0 0 0 12 8.445c-1.96 0-3.554 1.595-3.554 3.555S10.04 15.555 12 15.555a3.57 3.57 0 0 0 3.08-1.778l3.077 1.78A7.135 7.135 0 0 1 12 19.109zm7.309-5.529h-.79v.79h-.79v-.79h-.79v-.79h.79v-.79h.79v.79h.79zm-.79-2.24v.79h-.79v-.79h-.79v.79h-.79v-1.248l1.185-.686 1.185.686zm1.961 2.24h-.79v.79h-.79v-.79h-.79v-.79h.79v-.79h.79v.79h.79zm-.79-2.24v.79h-.79v-.79h-.79v.79h-.79v-1.248l1.185-.686 1.185.686z"/>
    </svg>
  )
}

// PHP — official Simple Icons path with fillRule so it renders correctly
function PhpIcon(p: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...p}>
      <path fillRule="evenodd" clipRule="evenodd" d="M0 12c0 3.486 5.373 6.313 12 6.313S24 15.486 24 12s-5.373-6.312-12-6.312S0 8.514 0 12zm7.93-1.793c.175.193.217.525.124.995-.095.49-.278.84-.55 1.049-.272.209-.686.314-1.242.314H5.424l.515-2.648h.944c.524 0 .872.097 1.047.29zm-4.278 5.328H5.03l.327-1.681h1.181c.52 0 .949-.056 1.285-.164.342-.113.656-.301.917-.551.26-.25.453-.58.554-1.15.147-.75.037-1.334-.33-1.752-.366-.419-.947-.628-1.744-.628H4.57l-1.23 6.326h.312zm8.055-2.723.326-1.681h-1.378l-.326 1.681h1.378zm-1.051-3.603h1.378l-.326 1.681h-1.378l.326-1.681zm2.426 0h-1.378l-1.23 6.326h1.378l.327-1.681h1.18c.52 0 .949-.056 1.285-.164.342-.113.656-.301.917-.551.26-.25.453-.58.554-1.15.147-.75.037-1.334-.33-1.752-.365-.419-.946-.628-1.703-.628zm.617 1.921c.174.193.216.525.123.995-.095.49-.278.84-.55 1.049-.272.209-.686.314-1.241.314h-.839l.515-2.648h.944c.524 0 .873.097 1.048.29zm3.708 1.682.326-1.681h-1.378l-.326 1.681h1.378zm-1.051-3.603h1.378l-.326 1.681h-1.378l.326-1.681zm2.426 0h-1.378l-1.23 6.326h1.378l.327-1.681h1.18c.52 0 .949-.056 1.285-.164.342-.113.656-.301.917-.551.26-.25.453-.58.554-1.15.147-.75.037-1.334-.33-1.752-.365-.419-.946-.628-1.703-.628zm.617 1.921c.174.193.216.525.123.995-.095.49-.278.84-.55 1.049-.272.209-.686.314-1.241.314h-.839l.515-2.648h.944c.524 0 .873.097 1.048.29z"/>
    </svg>
  )
}

// Python — official Simple Icons path
...
// Kotlin — official Simple Icons path
