...
const LanyardCard = dynamic(() => import('../components/band/LanyardCard'), { ssr: false });
                        ...
                        <div className="comment-row">
                          ...
                          <div className="comment-body">
                            <div className="comment-name-row">
                              ...
                              {c.is_pinned && (
                                <span className="pin-badge"><IconPin /> Pinned</span>
                              )}
                            </div>
